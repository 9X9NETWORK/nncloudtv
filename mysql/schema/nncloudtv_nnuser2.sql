...
--
-- Host: localhost    Database: nncloudtv_nnuser2
-- ------------------------------------------------------
...
CREATE TABLE `nnuser_profile` (
  ...
  `featured` bit(1) DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `nnuser_mso` (`userId`,`msoId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nnuser_subscribe` (
  ...
  `msoId` bigint(20) DEFAULT '1',
  PRIMARY KEY (`id`),
  UNIQUE KEY `userSubscribe` (`userId`,`channelId`,`msoId`),
...
-- Dump completed on 2013-12-24 16:57:05
