...
public class NnDateUtil {
    ...
    public static boolean isSameDay(Date date1, Date date2) {
        ...
        if (date1 == null || date2 == null) throw new IllegalArgumentException("The dates must no be null");
    ...
    public static boolean isSameDay(Calendar cal1, Calendar cal2) {
        ...
        if (cal1 == null || cal2 == null) throw new IllegalArgumentException("The dates must no be null");
